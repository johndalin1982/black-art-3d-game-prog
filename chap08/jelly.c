...
#ifdef VBE_SUPPORT
int IsrJellyX = -40,   // global variables that track the position of the
    IsrJellyY = 240;   // jelly fish, updated each frame in the main loop
#else
...
#ifdef VBE_SUPPORT
    spriteInit(&JellySprite, -40, 240, 32, 32, 0, 0, 0, 0, 0, 0);
#else
